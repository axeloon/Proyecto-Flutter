...
class HistoryService {
  ...
  static Future<List<History>> fetchHistory(
      String roomCode, String isoDate) async {
    ...
    try {
      ...
      throw Exception(
          'Error al realizar la solicitud para obtener el historial: $error');
    }
  }
  ...
  static Future<int> deleteReservation(String token) async {
    final Uri deleteUrl =
        Uri.https('api.sebastian.cl', 'booking/v1/reserve/$token/cancel');
    ...
    try {
      ...
      throw Exception(
          'Error al realizar la solicitud para eliminar la reserva: $error');
    }
  }
}
